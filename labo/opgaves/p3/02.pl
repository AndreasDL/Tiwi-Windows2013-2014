In de boomstructuur zien we dat de klasse achtereenvolgens afgeleid is van de (abstracte) klassen <i>CIM_PCVideoController</i>, <i>CIM_VideoController</i>, <i>CIM_Controller</i>, <i>CIM_LogicalDevice</i>, <i>CIM_LogicalElement</i> en <i>CIM_ManagedSystemElement</i>.
